...
class MultiplexaPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._fc_LPF_range = qtgui.Range(0, 10000, 10, 100, 200)
        ...
        self._W_range = qtgui.Range(0, 10000, 10, 10, 200)
        self._W_win = qtgui.RangeWidget(self._W_range, self.set_W, "Ancho Pulso", "counter_slider", float, QtCore.Qt.Horizontal)
