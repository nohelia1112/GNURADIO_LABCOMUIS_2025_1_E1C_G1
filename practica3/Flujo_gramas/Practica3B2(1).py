...
class Practica3B2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "Practica3B2")
        ...
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/estudiante/Descargas/lab3/Audio_de_prueba.wav', True)
...
def main(top_block_cls=Practica3B2, options=None):
